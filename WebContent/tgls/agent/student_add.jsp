...
<html>
	...
	<body>
		<div class="cBody">
			<form id="addForm" class="layui-form" action="${pageContext.request.contextPath }/StudentAddServlet" method="post">
					<label style="font-size:30px;">&nbsp; &nbsp; &nbsp; 新增学生--> </label>
					<br /> <br /> <br /> <br />
				<div class="layui-form-item">
					<label class="layui-form-label">学号</label>
					<div class="layui-input-inline shortInput">
						<input type="text" name="stuid" required autocomplete="off" class="layui-input">
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline shortInput">
						<input type="text" name="stuname" required autocomplete="off" class="layui-input">
					</div>
					<i class="iconfont icon-huaban bt"></i>
				</div>
				<div class="layui-form-item">
					...
					<div class="layui-input-inline shortInput">
						<input type="password" name="stupsw" required autocomplete="off" class="layui-input">
					</div>
					<i class="iconfont icon-huaban bt"></i>
				</div>
				<div class="layui-form-item">
					...
					<div class="layui-input-inline shortInput">
						<input type="text" name="stusex" autocomplete="off" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">邮箱</label>
					<div class="layui-input-inline shortInput">
						<input type="text" name="stuemail" autocomplete="off" class="layui-input">
					</div>
				</div>
