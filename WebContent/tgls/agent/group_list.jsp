		...
		<div class="cBody">
			<div class="console">
				<form class="layui-form" action="">
					<div class="layui-form-item">
						...
						<a href="${pageContext.request.contextPath }/GroupAddUIServlet" class="layui-btn">新增</a>
					</div>
				</form>
			...
			<table class="layui-table">
				...
				<tbody>
					...
					<c:forEach items="${allGroup }" var="groups" varStatus="status">
						<tr>
						<td>${status.index + 1 }</td>
						<td>${groups.grpid }</td>
						<td>${groups.grpname }</td>
						<td>${groups.stuname }</td>
						<td>${groups.proname }</td>
						<td>
							<a href="${pageContext.request.contextPath }/GroupDelServlet?id=${groups.grpid}"><button class="layui-btn layui-btn-xs">删除</button></a>
							<a href="${pageContext.request.contextPath }/GroupUpdateUIServlet?id=${groups.grpid}"><button  class="layui-btn layui-btn-xs">修改</button></a>
						</td>
						</tr>
					</c:forEach>
